...
flags.DEFINE_float('ep_end', 0.05, 'The value of epsilnon at the end in e-greedy')#0.01
...
flags.DEFINE_integer('memory_size', 100, 'The size of experience memory (*= scale)')#100*10000
flags.DEFINE_integer('t_target_q_update_freq', 1, 'The frequency of target network to be updated (*= scale)')#10000
flags.DEFINE_integer('t_test', 1, 'The maximum number of t while training (*= scale)')#10000
flags.DEFINE_integer('t_ep_end', 100, 'The time when epsilon reach ep_end (*= scale)')#100*10000
flags.DEFINE_integer('t_train_max',5000, 'The maximum number of t while training (*= scale)')#5000*10000
flags.DEFINE_float('t_learn_start', 5, 'The time when to begin training (*= scale)')#5*10000
flags.DEFINE_float('learning_rate_decay_step', 5, 'The learning rate of training (*= scale)')#5*10000

# Optimizer
flags.DEFINE_float('learning_rate', 1e-4, 'The learning rate of training')#0.00025
flags.DEFINE_float('learning_rate_minimum', 1e-4, 'The minimum learning rate of training')#0.00025
flags.DEFINE_float('learning_rate_decay', 0.99, 'The decay of learning rate of training')#0.96
