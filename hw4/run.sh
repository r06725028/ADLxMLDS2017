...
if [ ! -f model.data-00000-of-00001 ]; then
    curl ftp://140.112.107.150/r06725028/model.data-00000-of-00001 -o model.data-00000-of-00001
fi
...
if [ ! -f skipthoughts/bi_skip.npz ]; then
    curl ftp://140.112.107.150/r06725028/skipthoughts/bi_skip.npz -o skipthoughts/bi_skip.npz
fi
echo "bi_skip.npz ok!!!!"

if [ ! -f skipthoughts/btable.npy ]; then
    curl ftp://140.112.107.150/r06725028/skipthoughts/btable.npy -o skipthoughts/btable.npy
fi
echo "btable.npy ok!!!!"

if [ ! -f skipthoughts/uni_skip.npz ]; then
    curl ftp://140.112.107.150/r06725028/skipthoughts/uni_skip.npz -o skipthoughts/uni_skip.npz
fi
echo "uni_skip.npz ok!!!!"

if [ ! -f skipthoughts/utable.npy ]; then
    curl ftp://140.112.107.150/r06725028/skipthoughts/utable.npy -o skipthoughts/utable.npy
fi
echo "utable.npy ok!!!!"
